<?php namespace Edutalk\Base\StaticBlocks\Http\DataTables;
    ...
    protected function fetchDataForAjax()
    {
        return datatable()->of($this->model)
            ...
            ->addColumn('actions', function ($item) {
                ...
                /*Buttons*/
                $editBtn = link_to(route('admin::static-blocks.edit.get', ['id' => $item->id]), trans('edutalk-core::datatables.edit'), ['class' => 'btn btn-sm btn-outline green']);
